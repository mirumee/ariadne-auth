...
def test_require_permissions_no_permissions(test_authz: AuthorizationExtension):
...
def test_require_permissions_only_global_permissions(
    test_authz: AuthorizationExtension,
):
    ...
    with pytest.raises(GraphQLErrorAuthorizationError):
        assert decorated_resolver(None, None)


def test_require_permissions_single_permission_no_global_permissions(
    test_authz: AuthorizationExtension,
):
...
def test_require_permissions_single_permission_global_permissions_disabled(
    test_authz: AuthorizationExtension,
):
    """Permissions are set, global permissions is set but disabled"""
    test_authz.set_required_global_permissions(["create:Comments"])
...
def test_require_permissions_global_permission_user_has_permissions(
...
def test_require_permissions_set_permissions_and_global_fail(
    test_authz: AuthorizationExtension, read_comments_permissions_object
):
    """
...
def test_require_permissions_set_permissions_and_global_pass(
    test_authz: AuthorizationExtension, read_comments_permissions_object
):
    """
    additional permissions are set,
